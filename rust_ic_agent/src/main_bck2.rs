...
const URL: &'static str = concat!("http://localhost:", "8000");
...
async fn create_a_canister() -> Result<Principal, Box<dyn std::error::Error>> {
    ...
    let management_canister_id = Principal::from_text(String::from("rrkah-fqaaa-aaaaa-aaaaq-cai"))?;
    ...
    // let canister_id: Principal = result;
    Ok(result)
}
